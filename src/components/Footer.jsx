...
function Footer() {
  return (
    <div className="w-full flex gap-5 h-screen bg-zinc-900 text-8xl py-20 px-20">
      <div className="w-1/2 flex flex-col h-full justify-between font-sans">
        <div className="headings">
          <h1 className="text-[6vw] font-semibold uppercase -mb-5 leading-none">
            Eye-
          </h1>
          <h1 className="text-[6vw] font-semibold uppercase -mb-5 leading-none">
            Opening
      ...
      <div className="w-1/2">
        ...
        <div className="dets font-sans mt-60 ">
          
         </div>
          <div className="flex flex-col">
            <a className='block text-xl mx-40 underline mb-2 text-[#CDEA68] ' href="https://github.com/futxedits">Github</a>
            <a className='block text-xl mx-40 underline mb-2 text-[#CDEA68]' href="https://www.linkedin.com/in/ayush-tiwari-a43517277/">LinkedIn</a>
            <a className='block text-xl mx-40 underline text-[#CDEA68]' href="https://www.instagram.com/__ayushh__25?igsh=ZXVzcmcxc21kaGVy">Instagram</a>
             <p className="text-xl font-light mx-40  mt-60  text-zinc-400">
            © 2024 Ochi, Inc. All rights reserved.
          </p>
          </div>
      </div>
    </div>
